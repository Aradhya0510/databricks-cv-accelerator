...
Training script designed to run on Databricks Jobs compute
with automatic multi-GPU DDP support. Configure via Lakeflow Jobs UI parameters.
...
The trainer will automatically use all available GPUs with DDP strategy.
"""
